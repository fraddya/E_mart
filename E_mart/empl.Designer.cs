...
SELECT Emp_type, Emp_username, Emp_psw, Emp_ID, Emp_Name, Emp_address, Emp_TP, Emp_NIC, Emp_Email, Emp_DOB, Emp_regdate FROM Employer WHERE (Emp_ID = @Emp_ID)";
        ...
        public virtual int Fill(empl.EmployerDataTable dataTable) {
        ...
        public virtual empl.EmployerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            empl.EmployerDataTable dataTable = new empl.EmployerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(empl.EmployerDataTable dataTable) {
