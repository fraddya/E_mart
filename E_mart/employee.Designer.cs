...
namespace E_mart.employeeTableAdapters {
...
SELECT Emp_type, Emp_username, Emp_psw, Emp_ID, Emp_Name, Emp_address, Emp_TP, Emp_NIC, Emp_Email, Emp_DOB, Emp_regdate FROM Employer WHERE (Emp_ID = @Emp_ID)";
        ...
        public virtual int Fill(employee.EmployerDataTable dataTable) {
        ...
        public virtual employee.EmployerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            employee.EmployerDataTable dataTable = new employee.EmployerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(employee.EmployerDataTable dataTable) {
